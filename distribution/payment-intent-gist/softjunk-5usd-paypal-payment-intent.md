...
`6119956cb35088e8c1cabc3242c8dd6e28f4758a`
...
If the order context is already ready, create the shareable order link and generated note here:
...
Do not claim the order is paid, started, delivered, or complete unless seller-side PayPal evidence verifies the transaction or the verifier returns `PAYPAL_PAYMENT_VERIFIED=true`.

Verifier instructions:

https://github.com/trungcodeer/softjunk-lead-kit/blob/main/PAYPAL_VERIFICATION.md
