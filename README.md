...
- Niche template paid route: for the dental and appointment-setting templates, build the one-copy order packet first, then copy the after-packet PayPal URL when the packet and note are ready. Other niche templates remain packet-first before the after-packet PayPal handoff.
