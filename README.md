...
- Niche template paid route: for the dental, appointment-setting, med spa, tutoring, and HVAC templates, build the one-copy order packet first, then copy the after-packet PayPal URL when the packet and note are ready. Other niche templates remain packet-first before the after-packet PayPal handoff.
